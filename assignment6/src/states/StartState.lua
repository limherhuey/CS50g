...
function StartState:init()
    ...
    -- shape coordinates are wrt the body coordinates
    -- so eg. (0, 0) for groundShape is newBody's and actual screen's (self.world, 0)
...
function StartState:render()
    ...
    -- title text
    love.graphics.setColor(64/255, 64255, 64/255, 200/255)
